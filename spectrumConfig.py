...
class SpectrumConfigWindow(object):
    def __init__(self, spectro_unit):
        ...
        #self.motherWindow=.. ça nécessite de passer controlPannel en argument 
    ...
    def setupUi(self, Dialog):
        ...
        self.darkSpectrum.setGeometry(QtCore.QRect(1000, 60, 251, 171))
        self.darkSpectrum.setObjectName("darkSpectrum")
        self.abs_courante = QtWidgets.QGraphicsView(Dialog)
        self.abs_courante.setGeometry(QtCore.QRect(10, 40, 971, 621))
        ...
        self.reference.setGeometry(QtCore.QRect(1000, 290, 251, 171))
        ...
        self.intensity.setGeometry(QtCore.QRect(1000, 520, 251, 171))
        ...
        self.refresh_dark_spectrum.setGeometry(QtCore.QRect(1140, 20, 81, 31))
        self.refresh_dark_spectrum.setObjectName("refresh_dark_spectrum")
        self.refresh_ref = QtWidgets.QPushButton(Dialog)
        self.refresh_ref.setGeometry(QtCore.QRect(1140, 250, 81, 31))
