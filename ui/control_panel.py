...
class Ui_ControlPanel(object):
    def setupUi(self, ControlPanel):
        ...
        self.stop_syringe.setGeometry(QtCore.QRect(650, 580, 81, 41))
        self.stop_syringe.setObjectName("stop_syringe")
        self.connect_syringe_pump = QtWidgets.QPushButton(self.centralwidget)
        self.connect_syringe_pump.setGeometry(QtCore.QRect(610, 450, 121, 51))
        ...
        self.open_syringe_panel.setGeometry(QtCore.QRect(560, 520, 171, 41))
        ...
        self.led_disp.setGeometry(QtCore.QRect(560, 460, 31, 31))
        ...
        self.menu_file.addAction(self.actionchange_folder)
        self.menu_help.addAction(self.actionget_help)
        self.menu_settings.addAction(self.actionSyringes_parameters)
...
" Reagent 3"))
        ...
        self.actionchange_folder.setText(_translate("ControlPanel", "edit saving folder"))
