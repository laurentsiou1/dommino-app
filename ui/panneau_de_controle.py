...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.direct_pH.setGeometry(QtCore.QRect(590, 220, 101, 51))
        self.direct_pH.setObjectName("direct_pH")
        self.stabilisation_level = QtWidgets.QProgressBar(self.centralwidget)
        self.stabilisation_level.setGeometry(QtCore.QRect(590, 180, 101, 31))
        ...
        self.pH_label.setGeometry(QtCore.QRect(550, 220, 41, 51))
        ...
        self.stability_label.setGeometry(QtCore.QRect(590, 150, 101, 31))
        ...
        self.last_cal_label.setGeometry(QtCore.QRect(710, 60, 191, 41))
        ...
        self.cal_button.setGeometry(QtCore.QRect(590, 290, 101, 51))
        ...
        self.label_base_level.setGeometry(QtCore.QRect(550, 430, 301, 41))
        ...
        self.connect_phmeter.setGeometry(QtCore.QRect(540, 360, 151, 51))
        ...
        self.connect_syringe_pump.setGeometry(QtCore.QRect(530, 660, 181, 41))
        ...
        self.stab_time.setGeometry(QtCore.QRect(640, 120, 51, 31))
        ...
        self.calib_text_box.setGeometry(QtCore.QRect(710, 100, 331, 311))
        ...
        self.pump_speed_volt.setGeometry(QtCore.QRect(430, 740, 71, 31))
        ...
        self.change_dir.setGeometry(QtCore.QRect(240, 740, 171, 31))
        self.change_dir.setObjectName("change_dir")
        self.stab_step = QtWidgets.QDoubleSpinBox(self.centralwidget)
        self.stab_step.setGeometry(QtCore.QRect(570, 120, 51, 31))
        ...
        self.phmeter_selection_box.setGeometry(QtCore.QRect(490, 20, 201, 31))
        ...
        self.phmeter_selection_box.addItem("")
        self.phmeter_selection_box.addItem("")
        #self.phmeter_selection_box.set
        self.electrode_selection_box = QtWidgets.QComboBox(self.centralwidget)
        self.electrode_selection_box.setGeometry(QtCore.QRect(540, 70, 151, 31))
        ...
        self.load_calibration_button.setGeometry(QtCore.QRect(710, 20, 331, 31))
...
" on full syringe"))
        ...
        self.phmeter_selection_box.setCurrentText(_translate("MainWindow", "Phidget ADP1000"))
        self.phmeter_selection_box.setItemText(0, _translate("MainWindow", "Phidget ADP1000"))
        self.phmeter_selection_box.setItemText(1, _translate("MainWindow", "Phidget 1130"))
        self.phmeter_selection_box.setItemText(2, _translate("MainWindow", "HI5221"))
        self.phmeter_selection_box.setItemText(3, _translate("MainWindow", "Metrohm titrando"))
        self.phmeter_selection_box.setItemText(4, _translate("MainWindow", "other"))
        self.electrode_selection_box.setItemText(0, _translate("MainWindow", "Oakton epoxy"))
        self.electrode_selection_box.setItemText(1, _translate("MainWindow", "VWR 662-1793"))
        self.electrode_selection_box.setItemText(2, _translate("MainWindow", "metrohm 6.0232.100"))
        self.electrode_selection_box.setItemText(3, _translate("MainWindow", "metrohm 6.0259.100"))
        self.electrode_selection_box.setItemText(4, _translate("MainWindow", "other"))
        self.load_calibration_button.setText(_translate("MainWindow", "Select an existing calibration"))
